...
const InnovationSection = () => {
  return (
    <section className="py-12 px-7 bg-gray-50 flex flex-col md:flex-row items-center gap-10">
      {/* Image Section */}
      <div
        className="w-full md:w-1/2 flex justify-center items-center"
        data-aos="fade-right" // Animation from right
      ...
      >
        ...
        <p className="text-gray-600 text-lg leading-relaxed">
          FV Plus Agrotech Innovation is an emerging player in the field of
          fresh produce management. We specialize in pioneering and
          cost-effective technologies for processing fruits and vegetables. Our
          solutions aim to tackle food security challenges and promote
